...
struct UndoRedoTests {
    ...
    @Test func removalUndoesBackToTheSameRowAndRedoes() async throws {
        ...
        #expect(undo.undoTitle == "Undo Added Xeno")
        ...
        await undo.refresh()
        #expect(undo.undoTitle == "Undo Removed Xeno")
        ...
        #expect(undo.canRedo && undo.redoTitle == "Redo Removed Xeno")
    ...
    @Test func aDeckBuildUndoesHomeAndRedoesAndSoDoesDisassembly() async throws {
        ...
        await undo.refresh()
        #expect(undo.undoTitle == "Undo Built Test Deck")
        ...
        await undo.refresh()
        #expect(undo.undoTitle == "Undo Disassembled Test Deck")
        await undo.undo()
    ...
    @Test func anImportUndoesToEmptyAndRedoesIntact() async throws {
        ...
        let undo = UndoController(container: container)
        await undo.refresh()
        #expect(undo.undoTitle == "Undo Imported 2 Cards")
